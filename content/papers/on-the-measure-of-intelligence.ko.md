...
* 그러나 우리는 기술 평가는 진정한 능력 평가가 아님을 알게 되었다. 예를 들어, 체스는 인간의 거의 모든 고등 인지 기능을 사용해야 하므로 체스 기계를 만들면 인간 수준의 지능을 달성할 수 있다고 믿었으나, 체스 기계는 체스만 잘 둘 뿐 다른 어떤 능력도 발현하지 못했다.
* 다시 말해, 우리는 일반화에서 뛰어난 (기술이 좋은 것이 아니라 기술 습득 능력이 좋은) AI를 만들어야 하며, 이를 위해서 일반화 능력 측면에서 AI를 평가해야 한다.
* 심리측정학은 이런 평가를 위해 사용될 수 있다.
